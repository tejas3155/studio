...
export default function HrRoleSelectionPage() {
  return (
          ...
          <Link href="/dashboard/hr/executive">
            <Card className="group cursor-pointer border-border/20 bg-card/50 transition-all duration-300 hover:border-primary/50 hover:bg-card hover:shadow-2xl hover:shadow-primary/20 hover:-translate-y-2">
              <CardHeader className="flex flex-col items-center justify-center p-8 text-center">
                ...
                <CardDescription className="mt-2">Access high-level workforce insights, compliance risks, and culture analytics.</CardDescription>
              </CardHeader>
            </Card>
          </Link>
          <Link href="/dashboard/hr/coordinator">
            <Card className="group cursor-pointer border-border/20 bg-card/50 transition-all duration-300 hover:border-primary/50 hover:bg-card hover:shadow-2xl hover:shadow-primary/20 hover:-translate-y-2">
              <CardHeader className="flex flex-col items-center justify-center p-8 text-center">
                ...
                <CardDescription className="mt-2">Manage day-to-day HR tasks, document management, and AI-assisted workflows.</CardDescription>
              </CardHeader>
            </Card>
          </Link>
        </div>
