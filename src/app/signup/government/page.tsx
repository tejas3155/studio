      ...
      <div className="flex w-full items-center justify-center bg-card p-8 lg:w-1/2">
        <div className="w-full max-w-md">
          ...
          <div className="text-center">
            <h1 className="font-headline text-3xl font-bold text-foreground">Streamline Public Sector Operations</h1>
            <p className="mt-2 text-muted-foreground">
              Oversee policy implementation, manage public records, and ensure regulatory adherence with unparalleled efficiency.
            </p>
          </div>
          ...
          <form className="mt-8 space-y-6">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                    ...
                    <Input id="email" type="email" placeholder="name@gov.in" required className="pl-10" />
                </div>
              </div>
              <div className="space-y-2">
