      ...
      <div className="flex w-full items-center justify-center bg-card p-8 lg:w-1/2">
        <div className="w-full max-w-md">
          ...
          <div className="text-center">
            <h1 className="font-headline text-3xl font-bold text-foreground">Build and Scale Your Vision</h1>
            <p className="mt-2 text-muted-foreground">
              From idea to IPO, CoperVise helps you build, manage, and scale your vision.
            </p>
          </div>
